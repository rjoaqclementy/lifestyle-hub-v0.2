...
DROP CONSTRAINT IF EXISTS unique_user_member,
DROP CONSTRAINT IF EXISTS unique_guest_member;
...
CREATE INDEX IF NOT EXISTS idx_lobby_members_user ON lobby_members(user_id) WHERE user_id IS NOT NULL;
CREATE INDEX IF NOT EXISTS idx_lobby_members_guest ON lobby_members(guest_id) WHERE guest_id IS NOT NULL;
